...
import { Header } from "@/components/fraud/Header";
import { Footer } from "@/components/fraud/Footer";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FraudGuard AI — AI Voice Fraud Detector" },
      {
        name: "description",
        content: "Your AI-powered second brain against voice fraud.",
      },
